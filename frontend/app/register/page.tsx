...
export default function RegisterPage() {
  ...
  const passwordRequirements = [
    ...
    { met: formData.password.length >= 8, text: t('auth.reqMin8') },

    { met: /[A-Z]/.test(formData.password), text: t('auth.reqUpper') },

    { met: /[a-z]/.test(formData.password), text: t('auth.reqLower') },

    { met: /[0-9]/.test(formData.password), text: t('auth.reqNumber') },
          ...
          <div className="mt-8">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                ...
                <span className="px-4 bg-white dark:bg-gray-800 text-gray-500 font-medium">{t('auth.orSignUpWith')}</span>
